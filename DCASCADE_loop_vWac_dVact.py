        ...
        for n in network['n_hier']:  
            ...
            if np.any(time_lag != 0):
             ...
             #       print(V_dep_init.shape)
                ...
                if vary_width:
                    eros_max_vol_t = al_vol_all[t,n] * np.mean(time_lag)
                else:
            ...
            if np.any(time_lag != 1):
                ...
                if np.any(diff_pos): 
                    ...
                    if vary_width:
                        eros_max_vol_t = al_vol_all[t,n] * (1 - np.mean(time_lag))  #erosion maximum is active volume
                    else:
            ...
            if update_slope == True:
                ...
                if np.isnan(node_el[t+1][n]):
                    print(f"NaN detected node_el at t={t+1}, n={n}")
                    raise
                    sys.exit(1)
