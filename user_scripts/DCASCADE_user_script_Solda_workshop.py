...
#---Timescale
# timescale = len(name_q) #5844 #3287 # 3652
# print(timescale)
...
indx_tr_cap = 7 # 2: Wilkock and Crowe 2003; 3: Engelund and Hansen; 7: Rickenmann 2001
...
indx_slope_red =2 # 1: None (alternatives where developed for accounting for mountain stream roughness); 2:Rickenmann

# Width variation index:
indx_width_calc = 2 # 1: wac = static and defined in reach_data; 2: wac after Lugo et al. 2015; 3: wac multiplied with factor defined in module
