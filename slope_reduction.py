...
Reducing the slope for the transport capacity calculations enables to account
...
The formula by Nitsche et al. (2011) is based on the flow depth and the D84
    Nitsche, M., D. Rickenmann, J. M. Turowski, A. Badoux, and J. W. Kirchner
    (2011), Evaluation of bedload transport predictions using flow resistance
    equations to account for macro-roughness in steep mountain streams, Water
    Resour. Res., 47, W08513, doi:10.1029/2011WR010645.
