...
def dynamic_plot(data_output, ReachData, psi, **kwargs):
    ...
    def output_selection(event): 
        global indx
        if clicked.get() == "D50 active layer [mm]": 
            indx = "D50 active layer [mm]"
        elif clicked.get() == "Daily trasport capacity [m^3/day]":  
            indx = "Daily trasport capacity [m^3/day]"
        elif clicked.get() == "D50 deposited layer [mm]": 
            indx = "D50 deposited layer [mm]"
        elif clicked.get() == "D50 mobilised layer [mm]": 
            indx = "D50 mobilised layer [mm]"
    ...
    options = ["D50 active layer [mm]", "Daily trasport capacity [m^3/day]","D50 deposited layer [mm]", "D50 mobilised layer [mm]", 
