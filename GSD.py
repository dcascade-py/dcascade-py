...
def GSDcurvefit(D16, D50, D84, psi):
    ...
    psi      = 1xC vector defining the mean grain size of the sediment
               classes in Krumbein phi (φ) scale
    ----
    OUTPUT:
    Fi_r     = NxC matrix reporting the grain size frequency of the N reaches
               for the C sediment classes.
    resnorm  = 1xN vector listing the squared norm of the residuals of the fitting.
    par_opt  = 1x2 vector containing the optimizad values of the two parameter
               of the Rosin distribution, k and s.
    """
